...
<body>
	<form action="index.php?uc=historique&action=supprimerIpad" method="POST" onsubmit="return confirm('Voulez-vous vraiment supprimer les PC sélectionnés ?');">
		...
		<div class="reunion">
			<div class="search">
				...
				<div class="search__btn__plus">
					<a href="index.php?uc=historique&action=ajoutIpad"><input type="button" value="Ajouter" /></a>
				</div>
			</div>
					...
					<div class="checkbox__ligne">
						<div class="checkbox_ligne1">
							<ul class="pcList">
								...
								<li>
									<a class="checkbox__ligne1__modif" href="index.php?uc=historique&action=modifierIpad&id=<?= $PC['id_ipad'] ?>"></a>
								</li>
							</ul>
						</div>
					</div>
