		...
		<form action="index.php?uc=historique&action=modifierIpad" method="POST">
			...
			<div class="container__card__info">
				...
				<div>
					...
					<input type="text" id="residence" name="residence" value="<?php echo $residence; ?>">
				</div>
				...
				<div>
					...
					<input type="text" id="mytem" name="mytem" placeholder="TRACTION221123021" value="<?php echo $mytem; ?>">
				</div>
				...
				<div class="recu">
					...
					<input type="date" id="recu" name="recu" value="<?php echo $dateR; ?>">
				...
				<div class="realiser">
					...
					<input type="date" id="valider" name="ok" value="<?php echo $dateV; ?>">
